      ...
      <div className="w-64 flex-shrink-0 flex flex-col bg-background border-r border-gray-100">
        ...
        <nav className="flex-1 space-y-1">
          ...
          <SidebarItem 
            ...
            text="Budgets" 
            icon={<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 1v22"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>} 
          />
          <SidebarItem 
            to="/profile" 
